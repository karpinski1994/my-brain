...
- `my-brain/02_Wiki/` — AI-generated wiki pages (Layer 2)
...
- `my-brain/02_Wiki/index.md` exists with proper frontmatter
- `my-brain/02_Wiki/log.md` exists with proper frontmatter
