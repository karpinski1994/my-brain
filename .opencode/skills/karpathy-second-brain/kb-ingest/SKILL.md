---
name: kb-ingest
description: Ingest new source material from my-brain/01_Raw/ into the wiki — extract concepts, create/update wiki pages, update index.md and log.md
---
...
- "process everything in 01_Raw"

## Workflow

### Step 1: Identify the Source

Ask the user which file to ingest, or scan `my-brain/01_Raw/` for files newer than the last log entry in `my-brain/02_Wiki/log.md`.
...
Search `my-brain/02_Wiki/` for existing pages that are related. Read any that match. Decide what needs to be:
...
For each new page, create `my-brain/02_Wiki/<concept-name>.md`:
...
- **NEVER edit or modify files in `my-brain/01_Raw/`** — they are immutable source documents
